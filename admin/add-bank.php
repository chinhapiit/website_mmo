...
<body>
   ...
   <div class="container-fluid" bis_skin_checked="1">
      <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb" bis_skin_checked="1">
         <h1 class="page-title fw-semibold fs-18 mb-0">Thêm ngân hàng</h1>
         <div class="ms-md-1 ms-0" bis_skin_checked="1">
            <nav>
               <ol class="breadcrumb mb-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Thêm ngân hàng
            ...
            <div class="card custom-card" bis_skin_checked="1">
               <div class="card-header justify-content-between" bis_skin_checked="1">
                  ...
                  <div class="d-flex" bis_skin_checked="1">
                     <button data-bs-toggle="modal" data-bs-target="#exampleModalScrollable2" class="btn btn-sm btn-primary btn-wave waves-light waves-effect waves-light"><i class="ri-add-line fw-semibold align-middle"></i>Quay lại</button>
                  </div>
               </div>
               <div class="card-body" bis_skin_checked="1">
                  <form >
                     <div class="mb-4" bis_skin_checked="1">
                                ...
                                <input type="text" class="form-control" value="" list="options" id="ngang_hang" placeholder="Nhập tên ngân hàng" required="">
                                <datalist id="options">
                     ...
                     <div class="mb-4" bis_skin_checked="1">
                        ...
                        <input type="text" class="form-control" id="ctk"  placeholder="Nhập chủ tài khoản" required="">
                     </div>
                     <div class="mb-4" bis_skin_checked="1">
                        <label for="exampleInputEmail1">Số tài khoản</label>
                        <input type="text" class="form-control" id="stk"  placeholder="Nhập số tài khoản" required="">
                     </div>
                     <div class="mb-4" bis_skin_checked="1">
                     ...
                     <div class="mb-4" bis_skin_checked="1">
                        ...
                        <input type="text" class="form-control" id="min_nap"  placeholder="Tiền nạp tối thiểu" >
                     </div>
                     <div class="mb-4" bis_skin_checked="1">
                        <label for="exampleInputEmail1">Token</label>
                        <input type="text" class="form-control" id="token" value="" placeholder="Áp dụng khi cấu hình nạp tiền tự động.">
                     </div>
                     <a type="button" class="btn btn-hero btn-danger" href="/admin-nc/list-bank"><i class="fa fa-fw fa-undo me-1"></i>
                     Quay lại</a>
                     <button id="btnSavebank" class="btn btn-hero btn-success"><i class="fa fa-fw fa-save me-1"></i>Thêm Ngay</button>
                  </form>
                    <script>
