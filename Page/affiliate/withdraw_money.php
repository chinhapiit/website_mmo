                           ...
                           <div class="card-wrapper border rounded-3">
                              ...
                              <script>
                                $("#btnWithdraw").on("click", function() {
                                    ...
                                    $.post("/Ajax/affiliate/withdraw_money.php", myOTPData,
                                        function(data) {
                                            if (data.status == '2') {
                                                Swal.fire({
                                                    title: "Thành công",
                                                ...
                                                setTimeout(function() {
                                                    window.location = "/affiliate/ruttien"
                                                }, 2000);
                                            } else {
                                                Swal.fire({
                                                    title: "Lỗi",
                     ...
                     <div class="card">
                        ...
                        <div class="card-body">
                           <div class="card-wrapper border rounded-3">
                              <form class="row g-3">
                                 <div class="col-md-12">
                                    <label class="form-label" for="inputEmail4">Số tiền hoa hồng khả dụng : </label>
                                 </div>
                                 <h4 style="color: red;"><?=money($user['is_ref']);?>đ</h4>
                  ...
                  <div class="col-md-12" bis_skin_checked="1">
                     <div class="card" bis_skin_checked="1">
                        <div class="card-header" bis_skin_checked="1">
                           ...
                           <hr>
                           <form method="POST" action="/affiliate/ruttien">
                              <div class="row">
                        ...
                        <div class="table-responsive p-2" bis_skin_checked="1">
                           <table class="table">
                              ...
                              <tbody>
                                 <?php 
                                    $i = 1;
                                    foreach($ketnoi->get_list("SELECT * FROM `withdraw_money` WHERE `username` = '$username' AND `type` = 'affi' $id_amount  ORDER BY `id` DESC $id_limit") as $his_aff):?> 
                                 <tr>
                                    <td>
                                       <?=$i++;?>                                 
                                    </td>
