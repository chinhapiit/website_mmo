...
<head>
    ...
    <title>Quên mật khẩu - TEAM API IT</title>
    <!-- Google font-->
                                ...
                                <div class="login-main">
                                    <form class="theme-form">
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Nhập email của bạn</label>
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="checkbox p-0">
                                                ...
                                                <label class="text-muted" for="checkbox1">Xác nhận đặt mật khẩu</label>
                                            </div>
                                            <button class="btn btn-primary btn-block w-100" id="btnReset">Đặt lại</button>
                                        </div>
                                        <p class="mt-4 mb-0">Đã có tài khoản ?<a class="ms-2"
                                                href="/auth/login">Đăng nhập</a></p>
